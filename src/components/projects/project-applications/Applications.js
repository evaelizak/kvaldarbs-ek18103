...
const Applications = ({ type = 'student' }) => {
  ...
  // for showing the component if the company is approved
  let isApproved;
  if (type === 'company') {
  ...
  return (
    <div>
      <div>
        ...
        {!loading && applications && isStudent && applications.length > 0 && (
          <>
        ...
        {!loading && applications && !isStudent && isApproved === false && (
